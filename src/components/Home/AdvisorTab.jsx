  ...
  return (
    <div>
      <div className='bg-purple-600 py-8 raleway-500'>
        <div className='w-[70%] mx-auto text-white flex justify-between items-center'>
          <div className='basis-1/2'>
            <p className='agbalumo-regular w-[70%] text-5xl pb-4'> Confused about what to learn?</p>
      ...
      <div className='bg-black py-8 raleway-500'>
        ...
        <p className='agbalumo-regular w-[70%] text-5xl py-10 text-white'> Get onboard with us </p>
          <div className='text-white flex justify-between items-center'>
            <div className='basis-1/2'>
              <img src="/Professor-pana.png" alt="" />
            </div>
            <div className='basis-1/2'>
              <p className='agbalumo-regular w-[70%] text-9xl pb-4'> " </p>
              <p className='w-[70%]'> _______  is an organization that is focused on equipping African youths with the knowledge and digital skills needed today Our aim is to make tech knowledge accessible to every 
